                ...
                <ul className='navbar-items'>
                    ...
                    <li className='navbar-item theme-menu'>
                        ...
                        <ul className='theme-submenu'>
                            <div className={`theme-submenu-item ${theme === 'light' ? 'active-mode' : ''}`} onClick={toggleTheme}>
                            ...
                            <div className={`theme-submenu-item ${theme === 'dark' ? 'active-mode' : ''}`} onClick={toggleTheme}>
